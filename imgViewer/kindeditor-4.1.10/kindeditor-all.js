...
(function (window, undefined) {
    ...
    _extend(KWidget, {
        init: function (options) {
            ...
            // self.div = K('<div style="display:none;"></div>');
...
KindEditor.lang({
    ...
    'flash.height': '高度',
    'flash.upload': '上传',
    'flash.viewServer': '素材仓库',
    'media.url': 'URL',
    'media.width': '宽度',
    'media.height': '高度',
    'media.autostart': '自动播放',
    'media.upload': '上传',
    'media.viewServer': '素材仓库',
...
KindEditor.plugin('filemanager', function (K) {
    ...
    self.plugin.filemanagerDialog = function (options) {
        var width = K.undef(options.width, 1280),
			height = K.undef(options.height, 600),
        ...
        function createView(result) {
            ...
            for (var i = 0, len = fileList.length; i < len; i++) {
                ...
                var img = K('<img src="' + iconUrl + '" width="100%" height="100%" alt="' + data.filename + '" />');
                if (!data.is_dir || data.has_file) {
...
KindEditor.plugin('image', function (K) {
    ...
    self.plugin.imageDialog = function (options) {
        ...
        var html = [
			...
			'<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="' + K.addParam(uploadJson, 'dir=imageList') + '">',
			//file
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
...
(function (K) {
    ...
    K.extend(KSWFUpload, {
        ...
        appendFile: function (file) {
            ...
            var img = K('<img src="' + file.url + '" class="ke-img" data-status="' + file.filestatus + '" alt="' + file.name + '" />');
            photoDiv.append(img);
...
KindEditor.plugin('multiimage', function (K) {
    var self = this, name = 'multiimage',
		...
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg; *.jpeg; *.gif; *.png'),
    ...
    self.plugin.multiImageDialog = function (options) {
        ...
        var swfupload = K.swfupload({
            ...
            uploadUrl: K.addParam(uploadJson, 'dir=imageList'),
...
(function () {
    ...
    SWFUpload.prototype.initSettings = function () {
        ...
        // File Settings
        this.ensureDefault("file_types", "*.gif,*.jpg,*.jpeg,*.png,*.bmp");
